...
const Card = ({ children, className = "", hoverable = false, onClick }) => (
  <div
    onClick={onClick}
    className={`bg-white border border-gray-200 rounded-lg p-4 ${hoverable ? "hover:border-gray-300 hover:shadow-md transition-all cursor-pointer" : ""} ${className}`}
  >
    {children}
  </div>
);
...
const CourseCardLarge = ({ course, onSelect }) => (
  <Card hoverable onClick={() => onSelect(course)} className="flex gap-4">
    <div className="w-36 h-24 rounded bg-gray-100 flex items-center justify-center text-4xl shrink-0">
      {course.emoji}
    </div>
  ...
  const courses = [
    {
      ...
      description:
        "Master Python from scratch. Learn variables, data types, control flow, functions, and OOP.",
      level: "Beginner",
      lessons: 24,
      duration: "4h 30m",
      students: 12500,
    ...
    },
    {
      ...
      description:
        "Build modern web apps with React. Components, hooks, state management, and best practices.",
      level: "Intermediate",
      lessons: 18,
      duration: "3h 15m",
      students: 8300,
    ...
    },
    {
      ...
      description:
        "Learn SQL from the ground up. Write queries, join tables, aggregate data.",
      level: "Beginner",
      lessons: 12,
      duration: "2h 45m",
      students: 15200,
    ...
    },
    {
      ...
      description:
        "Understand ML fundamentals. Algorithms, model training, evaluation, and applications.",
      level: "Advanced",
      lessons: 20,
      duration: "4h",
      students: 9800,
      ...
      <main className="flex-1 p-6 overflow-auto">
        <div className="max-w-3xl mx-auto">
          <div className="flex items-center justify-between mb-4">
            ...
            <select className="bg-white border border-gray-200 rounded px-3 py-1.5 text-xs text-gray-900">
          ...
          <div className="relative mb-4">
            <input
              ...
              className="w-full bg-white border border-gray-200 rounded-lg px-4 py-2.5 pl-9 text-gray-900 text-sm placeholder-gray-400 focus:border-amber-500 focus:outline-none focus:ring-2 focus:ring-amber-500/20"
            />
