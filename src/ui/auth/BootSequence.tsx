...
const BootSequence = (): ReactElement => {
  ...
  return (
    <div className="flex flex-1 flex-col gap-2 rounded-2xl border border-border dark:border-accent-border bg-surface-strong p-6 font-mono text-sm leading-relaxed text-accent shadow-lg">
