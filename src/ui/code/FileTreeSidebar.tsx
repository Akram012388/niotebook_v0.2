...
const FileTreeSidebar = (): ReactElement => {
  ...
  if (collapsed) {
    return (
      <div className="flex min-w-0 h-full w-full flex-col items-center bg-workspace-sidebar pt-2 text-workspace-text" data-help-target="filetree">
        <button
          type="button"
  ...
  return (
    <div className="flex min-w-0 h-full w-full flex-col bg-workspace-sidebar text-workspace-text" data-help-target="filetree">
