...
- [~] OPS-3 (phase 3, preview refresh) — Pin preview-data refresh workflow to deployment-scoped key and token-based ingest/verify. Files: `.github/workflows/preview-data-refresh.yml`, `docs/session-tasks.md`. Status: in_progress.
