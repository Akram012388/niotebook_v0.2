...
const CourseCard = ({ emoji, title, lessons, duration, progress }) => (
  <Card hoverable>
    <div className="aspect-video rounded bg-gray-100 mb-3 flex items-center justify-center text-3xl">
      {emoji}
    </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-6">
            ...
            <Card hoverable className="flex gap-4">
              <div className="w-32 h-20 rounded bg-gray-100 flex items-center justify-center text-2xl shrink-0">
                🐍
              </div>
